...
const OurWorks = () => {
    return (
        <div id="carouselExampleIndicators" class="carousel slide bg-secondary p-2" data-ride="carousel">
            <h4 className='text-center  my-5'>Here are some<span className='text-success'>Best Watches</span></h4>
